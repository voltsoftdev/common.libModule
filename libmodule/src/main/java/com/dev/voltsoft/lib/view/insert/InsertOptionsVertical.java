...
import com.dev.voltsoft.lib.view.ObserverView;
import com.dev.voltsoft.lib.view.insert.model.ItemSelectOptions;
...
public class InsertOptionsVertical extends LinearLayout implements View.OnClickListener
{
    ...
    private void addSelectableOption(int i, final ItemSelectOptions.Option option)
    {
        ...
        TextView textView = view.findViewById(R.id.circlePointMessage);
