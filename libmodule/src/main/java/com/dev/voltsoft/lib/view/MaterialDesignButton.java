...
public class MaterialDesignButton extends android.support.v7.widget.AppCompatButton
{
    ...
    private void init(Context c, AttributeSet attrs, int defStyle)
    {
        ...
        ShapeColor = a.getColor(R.styleable.MaterialDesignButton_materialBackgroundColor,
                UtilityUI.getColor(c, R.color.insert_form_default_color));

        StorkeColor = a.getColor(R.styleable.MaterialDesignButton_materialBackgroundColor,
                UtilityUI.getColor(c, R.color.insert_form_default_color));
