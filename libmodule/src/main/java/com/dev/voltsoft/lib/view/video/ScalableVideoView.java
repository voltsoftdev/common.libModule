...
import com.dev.voltsoft.lib.view.HandlerThreadExtension;
 ...
 */
public class ScalableVideoView extends ScalableTextureView
     ...
     * If you need to use it you should synchronize in on {@link ScalableVideoView#mReadyForPlaybackIndicator} in order to have a consistent state.
            ...
            mViewHandlerBackgroundThread.post(new Runnable() {
                ...
                public void run() {
                    ...
                    synchronized (mReadyForPlaybackIndicator) {
                        ...
                        /** we have to notify a Thread may be in wait() state in {@link ScalableVideoView#start()} method*/
                        mReadyForPlaybackIndicator.notifyAll();
                    }
                }
            });
