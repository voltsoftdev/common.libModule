...
public class CircularProgressButton extends AppCompatButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mStrokeWidth = (int) getContext().getResources().getDimension(R.dimen.dp10);
...
//        mConfigurationChanged = false;
    ...
    public void setProgressState(final int progress , boolean bAnimEnable) {
        mConfigurationChanged = !bAnimEnable;
